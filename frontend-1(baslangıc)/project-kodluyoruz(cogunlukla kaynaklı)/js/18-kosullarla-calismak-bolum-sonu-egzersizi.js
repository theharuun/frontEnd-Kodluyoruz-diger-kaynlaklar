// ******** kosullarla-calismak-bolum-sonu-egzersizi.js *********
...
if (examGrade >= 0 && examGrade <= 100) {   // girdihgi not 100-0 arasındaysa buraya gir
    // tum if yapilari buraya gelsin
    textInfo = SMILE 
    info.classList.add('text-primary')
    if (examGrade >= 90) {          // 90 esit ve büyükse aa falan
        textInfo += " AA"
    ...
    textInfo = "Bilgiler Dogru Degil"  // 0-100 arası girmeyince bu bilgi
}
